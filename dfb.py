    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.instagram.com/muhamad_sidik23/')
                time.sleep(2)
                menu()
